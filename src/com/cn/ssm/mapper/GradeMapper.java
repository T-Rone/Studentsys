...
public interface GradeMapper {
	@SelectProvider(type = com.cn.ssm.mapper.provider.GradeDynaSqlProvider.class, method = "insertGrade")
...
//	List<Grade> selectAllGrade();
	...
	@SelectProvider(type = com.cn.ssm.mapper.provider.GradeDynaSqlProvider.class, method = "selectWhitParam")
	@Results({@Result(id = true, column = "id", property = "id"),@Result(column="score",property="score"),@Result(column = "usid", property = "student", one = @One(select = "com.cn.ssm.mapper.StuMapper.selectByUsid", fetchType = FetchType.EAGER)),@Result(column = "cid", property = "course", one = @One(select = "com.cn.ssm.mapper.CourseMapper.selectByCid", fetchType = FetchType.EAGER))})
	List<Grade> selectByPage(Map<String, Object> paramMap);

	@SelectProvider(type = com.cn.ssm.mapper.provider.GradeDynaSqlProvider.class, method = "count")
	...
	Grade selectById(int paramInt);
	 ...
	 @SelectProvider(type = com.cn.ssm.mapper.provider.GradeDynaSqlProvider.class, method = "updateGrade")
