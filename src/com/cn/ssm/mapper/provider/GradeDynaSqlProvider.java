   ...
   {
    {
	 ...
	 public String selectWhitParam(final Map<String, Object> params) {
		 ...
		 /*    */  SELECT("*");
		 /* 21 */     FROM("cj");
		 /* 22 */     if (params.get("grade") != null) {
		 /* 23 */      Grade grade = (Grade)params.get("grade");
		 	/* 45 */       if (grade.getScore() != null && !grade.getScore().equals("")){
			 	/* 46 */         WHERE("score LIKE CONCAT ('%',#{grade.score},'%') "); 
			 	/*    */      } 
	 ...
	 /*    */  {
	 	/* 41 */     SELECT("count(*)");
	 	/* 42 */     FROM("cj");
	 	/* 43 */     if (params.get("grade") != null) {
	 	/* 44 */       Grade grade = (Grade)params.get("grade");
	 	/* 45 */       if (grade.getCourse() != null && !grade.getCourse().getCid().equals("")){
	 	/* 46 */         WHERE("cid=#{course.cid} "); 
	 	/*    */      } 
	 	
	 					if (grade.getStudent() != null && !grade.getStudent().getUsid().equals("")){
		 	/* 46 */         WHERE("usid =#{student.usid}"); 
		 	/*    */      }
