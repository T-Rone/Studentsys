   ...
   {
    {
	 ...
	 public String selectWhitParam(final Map<String, Object> params) {
		 ...
		 /*    */  SELECT("*");
		 /* 21 */     FROM("department");
		 /* 22 */     if (params.get("department") != null) {
		 /* 23 */       Department department = (Department)params.get("department");
		 /* 24 */       if (department.getDepart_name() != null && !department.getDepart_name().equals("")){
		 /* 25 */         WHERE("  depart_name LIKE CONCAT ('%',#{department.depart_name},'%') "); 
		 /*    */     } 
		 			}}}).toString();
		 /*    */     
	 ...
	 /*    */  {
	 	/* 41 */     SELECT("count(*)");
	 	/* 42 */     FROM("department");
	 	/* 43 */     if (params.get("department") != null) {
	 	/* 44 */       Department department = (Department)params.get("department");
	 	/* 45 */       if (department.getDepart_name() != null && !department.getDepart_name().equals("")){
	 	/* 46 */         WHERE("  depart_name LIKE CONCAT ('%',#{department.depart_name},'%') "); 
	 	/*    */      } 
	 	/*    */   }
	 /*    */ }
	 /* 50 */       }).toString(); 
