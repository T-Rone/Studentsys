...
/*  89 */       mv.setViewName("view/insertGrade");
/*     */     } else {
/*     */       genericAssociation(usid, cid, grade);
/*  92 */       this.stuService.insertGrade(grade); //这就真添加了
/*     */       
/*  94 */       mv.setViewName("redirect:/view/selectGrade.do");//又通过控制器 跳到 查询页面
/*     */     } 
/*     */     
/*  97 */     return mv;
/*     */   }
...
/*     */   
  ...
  public ModelAndView updateGrade(String flag, @ModelAttribute Grade grade, ModelAndView mv, String usid,String cid) {
     if (flag.equals("1")) {
      ...
      Grade target = this.stuService.findGradeById(grade.getId()); //改成1 测试对的  莫非 页面grade对象 shutdown?
      	List<Student> students=this.stuService.findAllStudent();
		List<Course>  courses=this.stuService.findAllCourse();
