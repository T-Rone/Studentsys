...
import com.cn.ssm.mapper.CourseMapper;
import com.cn.ssm.mapper.GradeMapper;
import com.cn.ssm.mapper.SpeMapper;
import com.cn.ssm.mapper.StuMapper;
...
public class StuServiceImpl implements StuService {
	...
	public List<Department> selectAllDepartment(Department department, PageModel pageModel) {
		// TODO Auto-generated method stub
		 Map<String, Object> params = new HashMap<String, Object>();
			/* 148 */     params.put("department", department);
			/* 149 */     int recordCount = this.speMapper.count(params).intValue();
	...
	public List<Student> selectAllStu(Student student, PageModel pageModel) {
		// TODO Auto-generated method stub
		 Map<String, Object> params = new HashMap<String, Object>();
			/* 148 */     params.put("student", student);
			/* 149 */     int recordCount = this.stuMapper.count(params).intValue();
			/* 150 */     pageModel.setRecordCount(recordCount);
			/*     */     
			/* 152 */     if (recordCount > 0)
			/*     */     {
	...
	public List<Course> selectAllCourse(Course course, PageModel pageModel) {
		// TODO Auto-generated method stub
		Map<String, Object> params = new HashMap<String, Object>();
		/* 148 */     params.put("course", course);
		/* 149 */     int recordCount = this.courseMapper.count(params).intValue();
		/* 150 */     pageModel.setRecordCount(recordCount);
		/*     */     
		/* 152 */     if (recordCount > 0)
		/*     */     {
	...
	public List<User> findUser(User user, PageModel pageModel) {
		// TODO Auto-generated method stub
		 ...
		 /*  80 */     int recordCount = this.userMapper.count(params).intValue();
		 /*  81 */     pageModel.setRecordCount(recordCount);
		 /*  82 */     if (recordCount > 0)
		 /*     */     {
		 /*  84 */       params.put("pageModel", pageModel);
		 /*     */     }
		 /*  86 */     return this.userMapper.selectByPage(params);
		 /*     */   }
