...
<script >
  function check(){
		   ...
		   if(document.getElementById("name").value=="") {
               ...
               else if(document.getElementById("password").value!==document.getElementById("confirm")) {
                 alert("两次密码不一致！请重新输入！");
		...
		<div class="container demo-1">
			<div class="content">
				...
				<form action="${ctx}/view/insertUser.do?flag=2" name="loginForm" method="post">
							...
							<div class="input_outer">
								<span class="us_uer"></span>
								<input id="confirm" name="confirm" class="text" style="color: #FFFFFF !important; position:absolute; z-index:100;"value="" type="password" placeholder="请再次输入密码">
							</div>
							
							<div class="mb2">
							 		
							 		<input class="act-but submit" type="submit" onclick="check()" style="color: #FFFFFF;margin: 0 auto;" value="注册">
							</div>
