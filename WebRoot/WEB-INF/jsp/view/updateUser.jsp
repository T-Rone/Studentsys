...
<body>
  <form action="${ctx}/view/updateUser.do" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="table table-bordered table-hover definewidth m10">
		    ...
		    <td class="font3 fftd">
		    	...
		    	<tr><td>用户名：<input type="text" id="name" name="name" value="${user.name}"></td></tr>
            	<tr><td>密码：<input type="text" id="password" name="password" value="${user.password}"></td></tr>
