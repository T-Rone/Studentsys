...
<body>
 <form action="${ctx}/view/updateStudent.do" id="studentForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="table table-bordered table-hover definewidth m10">
		    <tr>
		    <td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">学号：<input type="text" name="usid" id="usid" size="20" value="${student.usid}"/></td>
		    		</tr>
		    	<tr><td>姓名：<input type="text" id="name" name="name" value="${student.name}"></td></tr>
            	<tr><td>学院：<input type="text" id="college" name="college" value="${student.college}"></td></tr>
            	<tr><td>专业：<input type="text" id="major" name="major" value="${student.major}"></td></tr>
            	<tr><td>班级：<input type="text" id="classes" name="classes" value="${student.classes}"></td></tr>
				...
				<tr><td>籍贯：<input type="text" id="home" name="home" value="${student.home}"></td></tr>
				<tr>
				<td class="font3 fftd">
