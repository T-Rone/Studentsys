  ...
  <form action="${ctx}/view/updateCourse.do" id="courseForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="table table-bordered table-hover definewidth m10">
		    ...
		    <td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">课程号：<input type="text" name="cid" id="cid" size="20" value="${course.cid}"/></td>
		    		</tr>
		    		
		    	<tr><td>课程名称：<input type="text" id="cname" name="cname" value="${course.cname}"></td></tr>
            	<tr><td>开课学期：<input type="text" id="term" name="term" value="${course.term}"></td></tr>
            	<tr><td>学时：<input type="text" id="period" name="period" value="${course.period}"></td></tr>
            	<tr><td>绩点：<input type="text" id="credit" name="credit" value="${course.credit}"></td></tr>
