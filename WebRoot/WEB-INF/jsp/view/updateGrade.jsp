...
<body><form action="${ctx}/view/updateGrade.do" id="gradeForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="table table-bordered table-hover definewidth m10">
		    ...
		    <td class="font3 fftd">
						   ...
						   <c:forEach items="${requestScope.students }" var="student">
						   		<c:choose>
			    					<c:when test="${grade.student.usid == student.usid }">
			    						<option value="${student.usid }" selected="selected">${student.usid }</option>
			    					</c:when>
			    					<c:otherwise>
            	...
            	<tr><td>成绩：<input type="text" id="score" name="score" value="${grade.score}"></td></tr>
